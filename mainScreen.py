...
class Main:
    ...
    def playVideo(self):
        ...
        cascade = cv2.CascadeClassifier("/Users/shivammehta/Desktop/pythonProject/pythonProject/haarcascade_frontalface_default.xml")
    ...
    def recognizeFace(self):
        image_list = os.listdir('/Users/shivammehta/Desktop/pythonProject/pythonProject/citizen')

        for img in image_list:
            try:
                result = DeepFace.verify(img1_path=self.frame, img2_path=f"/Users/shivammehta/Desktop/pythonProject/pythonProject/citizen/{img}")
                print(result)
